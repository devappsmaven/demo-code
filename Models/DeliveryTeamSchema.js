...
const DeliveryTeam = new Schema({
  ...
  referedBy: {type: String, trim: true,sparse: true,default:""},  
  venmoLink: {type: String, trim: true,sparse: true,default:""},  
  cashAppLink: {type: String, trim: true,sparse: true,default:""},  
...
module.exports = Mongoose.model('deliveryTeam', DeliveryTeam);